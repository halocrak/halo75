...
def banner():
    print ' \x1b[31;1m\n\n\n   \n\n   MRX Powerful DDOS Attack Tool / (STAF EROR 404) // Facebook : imfor halo & Telegram : i4m_mrx\n\n\n\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> ATTACK HAS BEEN STARTED <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n\n\n\n\t\t'


def banner1():
    print ' \x1b[31;1m \n\n\n\n  \n\n   MRX Powerful DDOS Attack Tool //  (STAF EROR) // Facebook : imfor halo & Telegram : i4m_mrx \n\n\n\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> ATTACK HAS BEEN FINISHED <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n\n\n\t\t'
...
def httpcall(url):
    ...
    try:
        ...
        set_flag(1)
        print '\x1b[31;1m 1337 DDOS ATTACKED'
        code = 500
